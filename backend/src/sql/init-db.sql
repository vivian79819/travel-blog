...
(
    ...
    'New Zealand, often referred to as the "Land of the Long White Cloud," offers a breathtaking array of natural wonders, from majestic mountains to pristine beaches. Whether you’re exploring the geothermal landscapes of Rotorua or the stunning fjords of Milford Sound, each destination presents unique experiences that captivate the senses. \n\nA journey through the North Island reveals vibrant cities like Auckland and Wellington, where you can immerse yourself in Maori culture and savor delicious local cuisine. Outdoor enthusiasts will find paradise in places like Queenstown, known for its adrenaline-pumping activities, including bungee jumping, skydiving, and hiking the scenic trails of the Remarkables. \n\nIn addition to its dramatic landscapes, New Zealand is home to rich wildlife, with opportunities to spot unique species like the kiwi and the Hector’s dolphin. The country’s commitment to conservation is evident in its numerous national parks and protected areas, which allow visitors to connect with nature in a sustainable way. As you travel through this enchanting land, the warmth of its people and the allure of its scenery will leave you with unforgettable memories that will beckon you to return.',
    '7.jpg',
    1,
    '2024-11-10'
),
...
(
    ...
    'Fiji, an archipelago of over 300 islands, is renowned for its stunning beaches, crystal-clear waters, and warm hospitality. This tropical paradise invites travelers to experience its breathtaking natural beauty and rich cultural heritage. From the moment you arrive, you are greeted with the enchanting sights of swaying palm trees, colorful coral reefs, and vibrant marine life that beckon for exploration. \n\nThe islands offer a plethora of activities, including snorkeling and diving in some of the world’s most pristine coral reefs, where you can encounter diverse marine species and explore underwater landscapes. For those seeking relaxation, the white sandy beaches provide the perfect backdrop for unwinding under the sun or enjoying a traditional Fijian massage at a luxury resort. \n\nBeyond the beaches, immerse yourself in the local culture by visiting traditional villages, where you can participate in a kava ceremony and learn about the customs and traditions of the Fijian people. The warmth and friendliness of the locals make every interaction memorable. As the day winds down, enjoy a sunset cruise or a beachside dinner, where fresh seafood and tropical fruits showcase the island’s culinary delights. With its stunning landscapes and vibrant culture, Fiji promises an unforgettable escape that will linger in your heart long after you leave.',
    '12.jpg',
    2,
    '2024-11-20'
);
