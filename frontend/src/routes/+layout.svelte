...
<nav>
  <ul>
    ...
    <li>
      <a href="/" class:active={path === "/"}><img src="/navbar/home.png" alt="home-icon" />Home</a>
    </li>
  </ul>
  <span />
        ...
        {#if data.isLoggedIn}
          ...
          <li>
            <a
              ...
              ><img src="/navbar/write.png" alt="write-icon" />Write Articles</a
            >
          </li>
          ...
          <li>
            <a
              ...
              ><img src="/navbar/user.png" alt="user-icon" />My Profile</a
            >
          </li>
          <!-- Link to log out -->
          <li>
            <button on:click={handleLogout}
              ><img src="/navbar/logout.png" alt="logout-icon" />Logout</button
            >
          </li>
        {:else}
          ...
          <li>
            <a
              ...
              ><img src="/navbar/login.png" alt="login-icon" />Login</a
            >
          </li>
          ...
          <li>
            <a
              ...
              ><img src="/navbar/signup.png" alt="signup-icon" />Sign Up</a
            >
          </li>
        {/if}
      </ul>
